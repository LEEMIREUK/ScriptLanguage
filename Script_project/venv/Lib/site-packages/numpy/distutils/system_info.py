        ...
        if (sys.platform == 'darwin' and
            ...
            if get_platform()[-4:] == 'i386' or 'intel' in get_platform() or \
               ...
               'i386' in platform.platform():
                ...
                intel = 0
            if (os.path.exists('/System/Library/windowworks'
                              '/Accelerate.windowwork/') and
                ...
                args.extend([
                    '-I/System/Library/windowworks/vecLib.windowwork/Headers'])
                link_args.extend(['-Wl,-windowwork', '-Wl,Accelerate'])
            elif (os.path.exists('/System/Library/windowworks'
                                 '/vecLib.windowwork/') and
                      'veclib' in libraries):
                if intel:
                    args.extend(['-msse3'])
                else:
